import React, { Children, useCallback, useMemo, useState, Fragment, useEffect } from 'react';
import ReactMarkdown from 'react-markdown';
import { MDBContainer, MDBRow, MDBCol, MDBTypography, MDBBox, MDBBadge, MDBTooltip, MDBBtn, MDBView, MDBMask, MDBIcon, MDBAnimation, MDBCard, MDBCardImage, MDBCardBody, MDBCardTitle, MDBCardText, MDBDataTable, MDBNav, MDBNavItem, MDBNavLink, MDBTabContent, MDBTabPane, MDBModal, MDBModalHeader, MDBModalBody, MDBModalFooter, MDBListGroup, MDBNavbar, MDBNavbarBrand, MDBNavbarToggler, MDBCollapse, MDBNavbarNav, MDBFooter, MDBDropdown, MDBDropdownToggle, MDBDropdownMenu, MDBDropdownItem, MDBListGroupItem } from 'mdbreact';
...
var Root = function Root(_ref) {
  ...
  return /*#__PURE__*/React.createElement(MDBContainer, _extends({
    style: style
  }, props), children);
};
...
var getLevel = function getLevel(children) {
  ...
  var keys = Children.toArray(children).map(function (c) {
...
var Grid = function Grid(_ref) {
  ...
  var renderGrid = useCallback(function (arr) {
    return arr instanceof Array && arr.every(function (c) {
      return isBlock(c);
    }) ? /*#__PURE__*/React.createElement(MDBRow, null, arr.map(function (c, i) {
...
var Delete = function Delete(_ref) {
  ...
  return /*#__PURE__*/React.createElement(MDBBadge, {
    className: className,
    color: color,
    style: style
  }, "\xD7", children);
...
var Button = function Button(_ref) {
  ...
  return /*#__PURE__*/React.createElement(MDBTooltip, {
    ...
    tag: "span",
    placement: "bottom"
  }, /*#__PURE__*/React.createElement("span", null, level === 1 ? /*#__PURE__*/React.createElement(MDBBadge, _extends({}, state, {
    children: children,
    color: color in colors ? color : "dark"
  })) : /*#__PURE__*/React.createElement(MDBBtn, _extends({}, state, {
    children: children,
    color: color
  }))), /*#__PURE__*/React.createElement("span", null, isOpened ? 'Opened' : hoverText)); //TODO (social?{social}:{color}
};
...
var Link = function Link(_ref) {
  ...
  return level > 0 ? /*#__PURE__*/React.createElement(Button, {
    level: level,
    social: social,
    href: href,
    onClick: onClick,
    ...
    className: className,
    style: style
  }, /*#__PURE__*/React.createElement("u", null, children));
};
...
var Image = function Image(_ref) {
  var children = _ref.children,
      ...
      props = _objectWithoutPropertiesLoose(_ref, ["children", "alt"]);

  if (!children && alt.slice(0, 1).match(':')) return /*#__PURE__*/React.createElement(MDBIcon, {
    icon: alt.slice(1)
  });
  ...
  return /*#__PURE__*/React.createElement(ImageView, _extends({}, props, {
    alt: alt,
    level: level,
    children: children
  }));
...
var Cards = function Cards(_ref) {
  ...
  var toHead = useCallback(function (row) {
  ...
  var Animation = useCallback(function (props) {
...
var Pills = function Pills(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Fragment, null, /*#__PURE__*/React.createElement(MDBNav, {
    style: {
      border: "none"
    },
    ...
    return /*#__PURE__*/React.createElement(Fragment, {
      key: i
    }, /*#__PURE__*/React.createElement(MDBNavItem, null, /*#__PURE__*/React.createElement(MDBNavLink, {
      link: true,
      to: "#",
      active: tab === i,
...
var Modal = function Modal(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Fragment, null, cards.map(function (card, i) {
    return /*#__PURE__*/React.createElement(Fragment, {
      key: i
    }, /*#__PURE__*/React.createElement(MDBBtn, _extends({
      className: className,
      color: color,
      style: style
    }, {
    ...
    }, card.column.label[0].props.children), /*#__PURE__*/React.createElement(MDBModalBody, null, " ", card.rows, " "), /*#__PURE__*/React.createElement(MDBModalFooter, null, /*#__PURE__*/React.createElement(MDBBtn, _extends({
      className: className,
      color: color,
      style: style
    }, {
...
var Table = function Table(_ref) {
  var _ref$columnAlignment = _ref.columnAlignment,
      ...
      _ref$style = _ref.style,
      style = _ref$style === void 0 ? {} : _ref$style,
      props = _objectWithoutPropertiesLoose(_ref, ["columnAlignment", "children", "className", "color", "style"]);
  ...
  })) return /*#__PURE__*/React.createElement(Cards, _extends({
    columns: columns,
    rows: rows,
    keys: keys,
    className: className,
  ...
  if (keys.every(function (key) {
  ...
  })) return getIsX(columns, 'delete') ? /*#__PURE__*/React.createElement(Modal, _extends({
    columns: columns,
    rows: rows,
    keys: keys,
    className: className,
    ...
    argments: columnAlignment
  })) : /*#__PURE__*/React.createElement(Pills, _extends({
    columns: columns,
    rows: rows,
    keys: keys,
    className: className,
...
var ListGroup = function ListGroup(_ref) {
  var children = _ref.children,
      ...
      style = _ref$style === void 0 ? {} : _ref$style;
  return useMemo(function () {
    return /*#__PURE__*/React.createElement(MDBListGroup, _extends({
      children: children,
      className: className,
      color: color,
      style: _extends({
...
var Navi = function Navi(_ref) {
  var _ref$className = _ref.className,
      ...
      _ref$style = _ref.style,
      style = _ref$style === void 0 ? {} : _ref$style,
      props = _objectWithoutPropertiesLoose(_ref, ["className", "color", "style"]);
  ...
  return /*#__PURE__*/React.createElement(MDBNavbar, _extends({
    color: color,
    className: className,
    style: style
  }, {
  ...
  }, getText(children[0].props.children))), /*#__PURE__*/React.createElement(MDBNavbarToggler, {
...
var Foot = function Foot(_ref) {
  ...
  return /*#__PURE__*/React.createElement(MDBFooter, state, /*#__PURE__*/React.createElement(MDBContainer, {
    fluid: true
  }, /*#__PURE__*/React.createElement(MDBRow, null, getarr(children).map(function (c, i) {
    return /*#__PURE__*/React.createElement(MDBCol, {
      key: i,
      onClick: function onClick() {
...
var Drop = function Drop(_ref) {
  ...
  return /*#__PURE__*/React.createElement(MDBDropdown, state, /*#__PURE__*/React.createElement(MDBDropdownToggle, {
    caret: true,
    color: color
  }, getText((_getArray$ = getarr(children)[0]) == null ? void 0 : (_getArray$$props = _getArray$.props) == null ? void 0 : _getArray$$props.children)), /*#__PURE__*/React.createElement(MDBDropdownMenu, {
    basic: true
  }, getarr(children).filter(function (_, i) {
    return i > 0;
  }).map(function (c, i) {
...
var List = function List(_ref) {
  ...
  if (getarr(children).every(function (c) {
    ...
    })) return /*#__PURE__*/React.createElement(Foot, state);
    if (getarr(children).every(function (c) {
      var _c$props3;

      return getAnyGr((_c$props3 = c.props) == null ? void 0 : _c$props3.children, 'link', 'emphasis').length;
    })) return /*#__PURE__*/React.createElement(Navi, state);
    return /*#__PURE__*/React.createElement(Drop, state);
  }

  return /*#__PURE__*/React.createElement(ListGroup, null, children);
  /***
...
var ListItem = function ListItem(_ref) {
  var children = _ref.children,
    ...
    padding: "0 50px"
      ...
      props = _objectWithoutPropertiesLoose(_ref, ["children", "className", "style"]);
  ...
  return /*#__PURE__*/React.createElement(MDBListGroupItem, {
    children: children,
    className: className,
    color: color,
    style: style
...
var Heading = function Heading(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    color: color,
    style: style
  }, Children.map(children, function (c, key) {
    var _ref2, _ref2$props, _ref3, _ref3$props;

    return !((_ref2 = c) == null ? void 0 : (_ref2$props = _ref2.props) == null ? void 0 : _ref2$props.children) ? null : /*#__PURE__*/React.createElement(Tag, {
      className: className,
      key: key
...
var Code = function Code(_ref) {
  ...
  var onDoubleClick = useCallback(function (_) {
  ...
  return /*#__PURE__*/React.createElement(Light, _extends({
...
var Mdmd = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
  var _ref$md = _ref.md,
    ...
    fontSize: "1rem"
      ...
      children = _ref.children,
      props = _objectWithoutPropertiesLoose(_ref, ["md", "path", "source", "className", "color", "style", "children"]);
  ...
  var renderers = useMemo(function () {
    return Object.assign.apply(Object, [{}].concat(renderersKey.map(function (key) {
      ...
      return _ref3 = {}, _ref3[key.charAt(0).toLowerCase() + key.slice(1)] = function (props) {
        return /*#__PURE__*/React.createElement(Renderer, _extends({}, props, {
          className: [className, props["className" + key]].filter(function (c) {
            return c;
          }).join(' '),
          color: color || props["color" + key],
          style: _extends({}, style, props["style" + key])
        }));
      }, _ref3;
    }), [props.renderers]));
...
export default Mdmd;
export { Blockquote, Code, Delete, Drop, Foot, Heading, Image, InlineCode, InlineMath, Link, List, ListGroup, ListItem, Math, Mdmd, Navi, Paragraph, Root, Table, Text, getAnyCh, getAnyGr, getGrid, getIsX, getLevel, getLink, getText, getarr, getcol, getkey, getrow, getths, gettrs };
